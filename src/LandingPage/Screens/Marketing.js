...
import img from '../../Images/DIGITAL MARKETING_035545.jpg'
...
const Marketing = () => {
  ...
  return (
    <div className='course'>
      ...
      <div className='users'>
        <h1>Digital & Content Creation Course</h1>
        <span className='user'>
          <FaUserGroup/>
        ...
        <div className='course-r'>
          ...
          <div>
            <span className='price'>
              <span>NGN150,000.00</span>
              <span className='price-slash'>NGN200,000.00</span>
            </span>
    ...
    <section className='course2'>
      <div className='course2-l'>
        ...
        <div className='course2-top'>
          ...
          <p>Unlock the power of digital marketing with our comprehensive course. Gain practical skills and earn a globally recognized certificate to kickstart your career in digital marketing.</p>
    ...
    <div className="learn">
      <h3>Graphic Design Tools to learn</h3>
    ...
    <section className='illustrate'>
      ...
      <h2>All Digital Marketing & Content Creation courses</h2>
